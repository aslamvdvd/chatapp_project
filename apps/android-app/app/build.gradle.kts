...
android {
    namespace = "com.aarchangel.chatapp"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.aarchangel.chatapp"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        ...
        buildConfigField("String", "API_URL", "\"http://192.168.31.103:8080\"")
    }
...
dependencies {
    ...
    // Material Components (for XML theming bridge if needed, or other components)
